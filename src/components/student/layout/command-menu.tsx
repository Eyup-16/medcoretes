  ...
  const navigationItems = [
    {
      group: 'Dashboard',
      items: [
        { title: 'Dashboard Home', url: '/student/dashboard', icon: BarChart3, description: 'View your performance overview' },
        { title: 'Analytics', url: '/student/analytics', icon: TrendingUp, description: 'Track your learning progress and performance insights' },
        { title: 'Study Materials', url: '/student/study', icon: BookOpen, description: 'Access study packs and courses' },
        ...
        { title: 'Discover Content', url: '/student/discover', icon: IconSearch, description: 'Find new study materials' },
    ...
    },
    {
      group: 'Learning',
      items: [
        { title: 'Session Results', url: '/student/sessions', icon: Target, description: 'Analyze your performance' },
        { title: 'Study Workspace', url: '/student/workspace', icon: FileText, description: 'Notes and study tools' },
      ]
    },
    {
      group: 'Account',
      items: [
        { title: 'Profile Settings', url: '/student/settings', icon: Settings, description: 'Manage your account' },
