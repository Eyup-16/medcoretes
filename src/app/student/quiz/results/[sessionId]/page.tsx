...
export default function QuizResultsPage() {
  ...
  useEffect(() => {
    if (apiSession) {
      ...
      // Process question results with unified data structure
      const questionResults = sessionData.questions?.map((question, index) => {
        const userAnswer = sessionData.userAnswers?.[question.id];
        ...
        return {
          ...
          userAnswer: selectedAnswer?.answerText || 'No answer',
          correctAnswer: correctAnswer?.answerText || 'Unknown',
          isCorrect: selectedAnswer?.isCorrect || userAnswer?.isCorrect || false,
