...
import { adaptStudentDashboardData } from '@/lib/data-adapters';
...
export default function StudentDashboard() {
  ...
  // Memoize dashboard data adaptation to prevent unnecessary recalculations
  const dashboardDataMemo = useMemo(() => {
    if (performance) {
      return adaptStudentDashboardData(performance, subscriptions);
    }
    return null;
  }, [performance, subscriptions]);

  // Update dashboard data when memoized data changes
  useEffect(() => {
