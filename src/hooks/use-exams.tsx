  ...
  const fetchExams = useCallback(async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        // Flatten the examsByYear structure to get a simple array of exams
        const flattenedExams = [];
        if (examsData.examsByYear) {
          examsData.examsByYear.forEach(yearGroup => {
            if (yearGroup.exams) {
              flattenedExams.push(...yearGroup.exams);
            }
          });
        }
